...
class PasswordDescription {
    constructor(elems) {
        const { passwordInput, passwordDescriptionUppercase, passwordDescriptionLowercase, passwordDescriptionContainNumber, passwordDescriptionSpecialCharacter, passwordDescriptionLength, submitButton } = elems;
...
const passwordDescription = new PasswordDescription({
    ...
    passwordDescriptionUppercase: document.querySelector("[data-control=password-uppercase]"),
    passwordDescriptionLowercase: document.querySelector("[data-control=password-lowercase]"),
    passwordDescriptionContainNumber: document.querySelector("[data-control=password-contain-number]"),
    passwordDescriptionSpecialCharacter: document.querySelector("[data-control=password-special-character]"),
    passwordDescriptionLength: document.querySelector("[data-control=password-length]"),
