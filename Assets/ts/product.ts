class QuantityControl {
    ...
    private decreasedButton: HTMLButtonElement;
    private increasedButton: HTMLButtonElement;

    constructor(elems: {
        input: HTMLInputElement;
        decreasedButton: HTMLButtonElement;
        increasedButton: HTMLButtonElement;
    }) {
...
class Description {
    ...
    private defaultDescriptionHeight: number = 0;
    ...
    setupEventListener() {
        const element = this.description.children[0] as HTMLDivElement;
    ...
    handleShowMore(description: HTMLDivElement) {
        const showMoreButtonWrapper = document.querySelector(".expand-description") as HTMLDivElement

        this.showMoreButton = document.querySelector(".expand-description-button") as HTMLButtonElement
...
const quantityControl = new QuantityControl({
    input: document.querySelector("#qty") as HTMLInputElement,
    decreasedButton: document.querySelector("[data-control=decreased]") as HTMLButtonElement,
    increasedButton: document.querySelector("[data-control=increased]") as HTMLButtonElement
})

const description = new Description({
    description: document.querySelector(".product-description-wrapper") as HTMLDivElement
})
